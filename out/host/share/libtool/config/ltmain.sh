...
if test -n "$STAGING_DIR_HOST"; then
	...
	: ${EGREP="/home/wanlong/workspace/v5/out/host/bin/grep -E"}
	: ${FGREP="/home/wanlong/workspace/v5/out/host/bin/grep -F"}
	: ${GREP="/home/wanlong/workspace/v5/out/host/bin/grep"}
	: ${SED="/home/wanlong/workspace/v5/out/host/bin/sed"}
fi

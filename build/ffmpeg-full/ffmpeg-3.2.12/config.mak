...
CC_IDENT=gcc 5.3.1 (Linaro GCC 5.3-2016.05) 20160412
ARCH=arm
INTRINSICS=neon
CC=arm-linux-gnueabi-gcc
CXX=arm-linux-gnueabi-g++
AS=arm-linux-gnueabi-gcc
OBJCC=arm-linux-gnueabi-gcc
LD=arm-linux-gnueabi-gcc
DEPCC=arm-linux-gnueabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=arm-linux-gnueabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
ARFLAGS=rcD
AR_O=$@
RANLIB=arm-linux-gnueabi-ranlib -D
...
CFLAGS=-Os -pipe -march=armv7-a -mtune=cortex-a7 -mfpu=neon -fno-caller-saves -fno-plt -mfloat-abi=softfp  -Wformat -Werror=format-security -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -I/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/out/v5-hdmi/staging_dir/target/usr/include -I/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/out/v5-hdmi/staging_dir/target/include -I/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/prebuilt/gcc/linux-x86/arm/toolchain-sun8iw12p1-glibc/toolchain/usr/include -I/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/prebuilt/gcc/linux-x86/arm/toolchain-sun8iw12p1-glibc/toolchain/include -fpic   -mcpu=cortex-a7 -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
DEPWINDRES=arm-linux-gnueabi-gcc
DOXYGEN=doxygen
LDFLAGS=-L/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/out/v5-hdmi/staging_dir/target/usr/lib -L/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/out/v5-hdmi/staging_dir/target/lib -L/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/prebuilt/gcc/linux-x86/arm/toolchain-sun8iw12p1-glibc/toolchain/usr/lib -L/home/shane/Downloads/action/New_SDK/Vecoo-SDK-v5-hdmi.Linux-x86_64/prebuilt/gcc/linux-x86/arm/toolchain-sun8iw12p1-glibc/toolchain/lib -znow -zrelro  -mcpu=cortex-a7 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=

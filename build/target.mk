...
ifeq ($(DUMP),)
  PLATFORM_DIR:=$(TOPDIR)/target/vecoo/$(BOARD)
  PLATFORM_COMMON_DIR:=$(TOPDIR)/target/vecoo/$(shell echo -n $(BOARD) | sed -e 's/-.*//g')-common
...
GENERIC_PLATFORM_DIR := $(TOPDIR)/target/vecoo/generic
